...
article_types = {u'programming': ['Python', 'Java', 'JavaScript'],
                 'Linux': [u'Linux info', u'Linux maintance', 'CentOS', 'Ubuntu'],
                 u'network': [u'cisco', u'others'],
                 u'database': ['MySQL', 'Redis'],
                 u'life': [u'university', u'love',u'AI'],
                 u'Web': ['Flask', 'Django'],}
...
class Menu(db.Model):
    ...
    @staticmethod
    def insert_menus():
        menus = [u'Web', u'database', u'network', u'life',
                 u'Linux world', u'programming']
        for name in menus:
            menu = Menu(name=name)
            db.session.add(menu)
            db.session.commit()
    ...
    def return_menus():
        ...
        menus.append((-1, u'not select navi'))
        return menus
...
class ArticleType(db.Model):
    ...
    def insert_system_articleType():
        articleType = ArticleType(name=u'default type',
                                  introduction=u'default type cant deleted',
    ...
    def insert_articleTypes():
        articleTypes = ['Python', 'Java', 'JavaScript', 'Django',
                        ...
                        u'Linux', u'Linux info', u'other',
                        u'cisco', u'life', u'university',
                        u'love', 'Flask']
...
class BlogInfo(db.Model):
    ...
    def insert_blog_info():
        blog_mini_info = BlogInfo(title=u' Pyblog',
                                  signature=u'A Blog system based on Python Flask and SQL lite database',
                                  navbar='inverse')
...
class Plugin(db.Model):
    ...
    def insert_system_plugin():
        plugin = Plugin(title=u'blog statistics',
                        note=u'system plugins',
